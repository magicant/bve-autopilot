...
namespace autopilot
{
    ...
    struct 制限グラフ::制限区間
    {
        ...
        旧式パターン 目標パターン(mps2 初期減速度) const;
    };
    ...
    旧式パターン 制限グラフ::制限区間::目標パターン(mps2 初期減速度) const
    {
        ...
        if (初期減速度 == mps2::無限大()) {
            ...
            最終減速度 = 旧式パターン::停止最終減速度;
        }
        else {
            最終減速度 = 旧式パターン::標準最終減速度;
        }
        return 旧式パターン{減速目標地点, 目標速度, 初期減速度, 最終減速度};
    }
